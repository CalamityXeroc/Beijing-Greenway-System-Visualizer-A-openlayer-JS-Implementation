  ...
  <div class="toolbar-container">
    ...
    <div v-else class="map-toolbar">
      ...
      <div class="tool-section">
        ...
        <div v-if="activeTool === 'point'" class="draw-style-panel">
          ...
          <div class="style-row">
            ...
            <div class="style-field">
              ...
              <div class="color-input-wrap">
                ...
                <input type="color" v-model="drawStyles.point.fillColor" />

                <span class="color-hex">{{ drawStyles.point.fillColor }}</span>
            ...
            <div class="style-field">
              ...
              <div class="color-input-wrap">
                ...
                <input type="color" v-model="drawStyles.point.strokeColor" />

                <span class="color-hex">{{ drawStyles.point.strokeColor }}</span>
          ...
          <div class="style-row">
            ...
            <div class="style-field">
              ...
              <label>半径 {{ drawStyles.point.radius }}</label>

              <input type="range" v-model.number="drawStyles.point.radius" min="3" max="20" />

            </div>

            <div class="style-field">

              <label>边宽 {{ drawStyles.point.strokeWidth }}</label>

              <input type="range" v-model.number="drawStyles.point.strokeWidth" min="1" max="6" />
        ...
        <div v-if="activeTool === 'line'" class="draw-style-panel">
          ...
          <div class="style-row">
            ...
            <div class="style-field" style="flex: 2">
              ...
              <div class="color-input-wrap">
                ...
                <input type="color" v-model="drawStyles.line.color" />

                <span class="color-hex">{{ drawStyles.line.color }}</span>
            ...
            <div class="style-field">
              ...
              <label>线宽 {{ drawStyles.line.width }}</label>

              <input type="range" v-model.number="drawStyles.line.width" min="1" max="12" />
          ...
          <div class="style-row">
            ...
            <div class="style-field">
              ...
              <select v-model="drawStyles.line.dash" class="style-select">
        ...
        <div v-if="activeTool === 'polygon'" class="draw-style-panel">
          ...
          <div class="style-row">
            ...
            <div class="style-field">
              ...
              <div class="color-input-wrap">
                ...
                <input type="color" v-model="drawStyles.polygon.fillColor" />

                <span class="color-hex">{{ drawStyles.polygon.fillColor }}</span>
            ...
            <div class="style-field">
              ...
              <div class="color-input-wrap">
                ...
                <input type="color" v-model="drawStyles.polygon.strokeColor" />

                <span class="color-hex">{{ drawStyles.polygon.strokeColor }}</span>
          ...
          <div class="style-row">
            ...
            <div class="style-field">
              ...
              <label>透明度 {{ Math.round(drawStyles.polygon.fillOpacity * 100) }}%</label>

              <input type="range" v-model.number="drawStyles.polygon.fillOpacity" min="0" max="1" step="0.05" />

            </div>

            <div class="style-field">

              <label>边宽 {{ drawStyles.polygon.strokeWidth }}</label>

              <input type="range" v-model.number="drawStyles.polygon.strokeWidth" min="1" max="8" />
...
<!-- 图层管理 -->
      ...
      <div class="tool-section">
        ...
        <h4><i class="fas fa-download"></i> 导出</h4>

        <button class="tool-btn-export" @click="exportMapImage" title="将当前地图视图导出为PNG图片">
...
// 根据当前 drawStyles 构建 OL Style

const buildDrawStyle = (type) => {

  if (type === 'point') {

    const s = drawStyles.point
    ...
    return new Style({
      ...
      image: new CircleStyle({
        ...
        fill: new Fill({ color: hexToRgba(s.fillColor) }),

        stroke: new Stroke({ color: hexToRgba(s.strokeColor), width: s.strokeWidth })
    ...
    const s = drawStyles.line

    const lineDash = s.dash === 'dash' ? [10, 6] : s.dash === 'dot' ? [3, 6] : undefined
...
const activateDrawTool = (type) => {
  ...
  drawInteraction.on('drawend', (evt) => {
    ...
    // 在要素完成时，将当前样式冻结到要素上（避免全局样式改变后影响已绘制要素）

    const frozenStyle = buildDrawStyle(type)

    evt.feature.setStyle(frozenStyle)
...
// 导出地图为 PNG 图片（OpenLayers canvas 合成）

// 瓦片通过后端代理加载（/api/tiles/gaode），保证 CORS 头存在，canvas 不被污染
