<template>
  <div class="aosen-page">
    ...
    <section class="detail-comments-section">
      <DesktopCommentsPanel greenway-name="北京奥林匹克森林公园绿道" />
    </section>
    <!-- 天气卡片（固定定位，可拖动） -->
    <WeatherCard
