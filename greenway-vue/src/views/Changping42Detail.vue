<template>
  <div class="changping42-page">
    ...
    <section class="detail-comments-section">
      <DesktopCommentsPanel greenway-name="北京昌平42绿道" />
    </section>
    <!-- 天气卡片（固定定位，可拖动） -->
    <WeatherCard
