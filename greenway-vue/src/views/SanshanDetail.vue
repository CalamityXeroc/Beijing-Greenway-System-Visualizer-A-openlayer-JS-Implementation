<template>
  ...
  <div class="sanshan-page">
    ...
    <section class="detail-comments-section">
      ...
      <DesktopCommentsPanel greenway-name="北京三山五园绿道" />
...
const loadGreenwayData = async () => {
  ...
  try {
    ...
    const greenwayData = await loadGreenwayDataByName('三山五园', (data) => {
